    ...
    <SafeAreaView style={tailwind`flex-1 bg-white`}>
        <View style={tailwind`flex-1 px-6`}>
          ...
          <ScrollView showsVerticalScrollIndicator={false} style={tailwind`flex-1`}>
            <MenuList icon='credit-card' title='Payment Method' link={() => {}}/>
            <MenuList icon='edit' title='Update Profile' link={() => navigation.navigate('EditDetailsStack')}/>
            <MenuList icon='lock' title='Change Password' link={() => {}}/>
            <MenuList icon='users' title='Invite Friends' link={() => {}}/>
            <MenuList icon='help-circle' title='FAQS' link={() => {}}/>
            <MenuList icon='message-square' title='Help &  Support' link={() => navigation.navigate('HelpsupportStack')}/>
